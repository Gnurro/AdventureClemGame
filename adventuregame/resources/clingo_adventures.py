...
class ClingoAdventureGenerator(object):
    ...
    def _generate_goal_facts(self, initial_world_state):
        ...
        if task_config['task'] == "deliver":
            ...
            # hidden goal object filter:
            if 'hidden_deliverables' in task_config and task_config['hidden_deliverables'] == True:
            ...
            # add room locations for different room target checks:
            if 'different_room_delivery' in task_config and task_config['different_room_delivery'] == True:
                for fact in initial_facts:
                    for takeable, takeable_values in takeables.items():
            ...
            for takeable, takeable_values in takeables.items():
                for holder, holder_values in holders.items():
                    if not takeable_values['holder'] == holder:
                        ...
                        # different room source and target:
                        if 'different_room_delivery' in task_config and task_config['different_room_delivery'] == True:
            ...
            for goal_combo in goal_permutations:
                ...
                for goal in goal_combo:
                    if goal[1] not in goal_objects:
                        ...
                        duplicate = True
                    if 'different_delivery_targets' in task_config and task_config['different_delivery_targets'] == True:
